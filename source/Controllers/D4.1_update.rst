...
:numref:`my-figure`. In the following sections, we will introduce and
...
implemented. Together with the appropriate motor drivers (see section :numref:`two.two.three-section`),
...
sensors (:numref:`two.two.two-section`) and MYO-Perceptors, the external
sensors (:numref:`two.two.five-section`).
...
communicates with the MYO-Ganglion CAN bus (see :numref:`my-figure`).
